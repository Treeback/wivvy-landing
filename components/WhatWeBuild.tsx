      ...
      <div className="container-page">
        ...
        <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-6">
          {cards.map((c, i) => (
            ...
            >
              <div
                className={`group relative h-full overflow-hidden rounded-[32px] p-7 transition-transform duration-300 hover:-translate-y-2 hover:rotate-0 ${c.bg} ${c.text} ${c.rotate} ${c.border || ''}`}
              >
