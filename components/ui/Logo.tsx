  ...
  return (
    ...
    >
      ...
      <g>
        {/* Left side: Data bars */}
        <g>
          <rect x="8" y="22" width="3" height="8" fill="currentColor" opacity="0.4" />
          <rect x="13" y="18" width="3" height="12" fill="currentColor" opacity="0.6" />
          <rect x="18" y="14" width="3" height="16" fill="currentColor" opacity="0.8" />
        </g>
